...
class ProductVendor(Base):
    ...
    product_id = Column(Integer, ForeignKey("components.id"), primary_key=True)
    ...
    product = relationship(
        "inventory.models.Component", back_populates="product_vendors"
    )
    vendor = relationship(
        "inventory.list_vendors.models.ListVendors", back_populates="vendor_products"
    )
